...
public class CreateImage {
	...
	static final String[] EXTENSIONS = new String[] { "gif", "png", "bmp", "jpg" // and other formats you need
	};
	...
	public static void main(String[] args) {
		...
		for (int x = 0; x < 2; x++) {
			...
			for (int i = 1; i <= 300; i++) {
				...
				try {
					ImageIO.write(xyz, "jpg", new File(path + "\\test" + i + ".jpg"));
				} catch (Exception e) {
				}
	...
	public static void blurimage(String originalpath, String targetpath) {
